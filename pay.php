...
<script src="bootstrap/js/jquery1.js"></script>
	...
	function myfunction(){
	var x=0;
	x=document.getElementById("myinput2");
	var y=x.value*5;
	document.getElementById("mypara2").innerHTML=y;
       }	 
	</script>
<?php
...
<div id="wrapper">
 ...
 $row = mysqli_fetch_array($q);
  ...
  <li role="presentation" class="active"><a href="pay.php">Pay now</a></li>
  <li role="presentation"><a href="history.php">History</a></li>
</ul>
	<?php $id=$_SESSION['id'];
if(isset($_POST['bookid'])&& isset($_POST['coupon'])){
if(!empty($_POST['bookid']) && !empty($_POST['coupon'])){
$bookid=$_POST['bookid'];
$coupon=$_POST['coupon'];
$query1="Select bookid from books where bookid='$bookid'";
$query2="select wallet from reader where id='$id'";
...
if($row2[0]>=$coupon){
$query3="update reader set wallet = wallet-'$coupon' where id='$id'";
$qresult3=mysqli_query($link,$query3);
$query4="insert into payment(id,bookid,payid,coupon,timestamp)values('$id','$bookid',UUID_SHORT(),'$coupon',now())";
$qresult4=mysqli_query($link,$query4);
?>

<div class="alert alert-success alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
  <strong>Notice:  </strong>Transaction successfully completed.
</div>
<?php
}
else{?>
...
<div class="alert alert-warning alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
  <strong>Notice:  </strong>You do not have insufficient coupons to accomplish this payment.Please buy them from the library.
</div>
...
<div class="alert alert-warning alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
  <strong>Notice:  </strong>The Book Id you entered is invalid!!.Please try again!!.
</div>
...
<form class="form-horizontal" role="form" action="pay.php" method="POST">
  <div class="form-group">
    <label for="inputEmail3" class="col-md-2 control-label">Book id</label>
    <div class="col-md-6">
      <input type="text" class="form-control" id="inputEmail3" placeholder="Give its unique identity" name="bookid" required>
    </div>
  </div>
  <div class="form-group">
    <label for="inputText" class="col-sm-2 control-label" required>Coupons</label>
    <div class="col-sm-6">
      <input type="number" class="form-control" id="myinput2" placeholder="I promise to pay these." onchange="myfunction()" value="0" name="coupon">
    </div>
  </div>
  <div class="form-group">
      <label class="col-md-2 control-label">Value(in INR)</label>
	  <div class=" col-sm-10 form-control-static" id="mypara2">0</div>
  </div>
  <div class="form-group">
