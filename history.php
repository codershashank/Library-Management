...
<div id="wrapper">
 ...
 $row = mysqli_fetch_array($q);
  ...
  <th>#COUPONS</th>
	<?php 
	$query="select payid,timestamp,bookid,coupon from payment where id='$id'";
	$qresult1=mysqli_query($link,$query);
	while($row1=mysqli_fetch_assoc($qresult1))
	{
	?>
	<tr>
	<td><?php echo $row1['payid']; ?></td>
	<td><?php echo $row1['timestamp']; ?></td>
	<td><?php echo $row1['bookid']; ?></td>
	<td><?php echo $row1['coupon']; ?></td>
	</tr>
    <?php
	}
	?>
