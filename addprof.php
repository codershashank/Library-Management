...
$query1="INSERT into professors (id,name,email,passkey,address,dob,phone,img)values('$newid','$newname','$newemail','$newpassword','$address','$dob','$phone','$img')";
$query_run1=mysqli_query($link,$query1);
if($query_run1)
	echo'DONE';
header('Location:allprof.php');
}
}
?>
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 well well-sm">
            <legend><a href="http://www.jquery2dotnet.com"><i class="glyphicon glyphicon-globe"></i></a> Add Professor</legend>
           <center>
		   <form action="loginpage2.php" method="post" class="form" role="form">
			...
			<label class="col-md-3 control-label">User Id</label>
				<div class="col-md-9">
				 <input class="form-control" name="yourid" placeholder="ID [format:prof#####]" type="text"/>
				</div>   
			</div>
